                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="main_title mt50">
                            <h2>About Luxury Touch Hotel</h2>
                        </div>
                        ...
                        <div class="sidebar">
                            ...
                            <aside class="widget">
                                ...
                                <div class="help">
                                    ...
                                    <div class="phone"><i class="fa  fa-phone"></i><a href="tel:18475555555"> +233 456 876 789 </a></div>
                                    <div class="email"><i class="fa  fa-envelope-o "></i><a href="mailto:info@luxurytouchhotel.com">info@luxurytouchhotel.com</a> or use <a href="contact.html"> contact form</a></div>
                                </div>
                            </aside>
                            <!--
                            <aside class="widget">
